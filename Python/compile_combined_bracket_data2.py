...
for year in range(2024, 2025):
    ...
    for round in range(1, 7):
        ...
        #                          on=['Team__2', 'Seed__2'],
        #                          how='inner')
        df_join2 = pd.merge(df_round, df_kp2, on='Team__2', how='inner')
        df_join2 = df_join2.drop(columns=['Seed__2_x'])
        df_join2 = df_join2.rename(columns={'Seed__2_y': 'Seed__2'})
        # print(df_join2['Seed__2'])
        ...
        #                                   on=join_cols_common,
        #                                   how='left')
        df_round_combined = pd.merge(df_join1, df_join2, on=join_cols_common, how='left')
        # df_join2 = df_join2.drop(columns=['Seed__2_x'])
        # df_join2 = df_join2.rename(columns={'Seed__2_y': 'Seed__2'})
        print(df_round_combined)
