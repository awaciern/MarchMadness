#!/usr/bin/env python3
"""Run HGB-centric ensemble combos after discovering HGB+LDA_d2+LR_core = 75.56%."""
...
# New combos to test (HGB-centric)
COMBOS = [
    # HGB as a diversity anchor
    ("HGB+LDA_d2+SVC_d2",     "HGB",  "LDA_d2",   "SVC_d2"),
    ("HGB+LDA_d2+SVC_core",   "HGB",  "LDA_d2",   "SVC_core"),
    ("HGB+LDA_d2+LDA_core",   "HGB",  "LDA_d2",   "LDA_core"),
    ("HGB+LDA_core+LR_core",  "HGB",  "LDA_core", "LR_core"),
    ("HGB+LDA_core+SVC_d2",   "HGB",  "LDA_core", "SVC_d2"),
    ("HGB+SVC_d2+LR_core",    "HGB",  "SVC_d2",   "LR_core"),
    ("HGB+SVC_core+LDA_d2",   "HGB",  "SVC_core", "LDA_d2"),  # LDA_d2+SVC_core+HGB
]
...
best_avg = 0.7556  # current best: HGB+LDA_d2+LR_core
